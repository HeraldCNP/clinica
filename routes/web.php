...
Route::group(['middleware' => ['auth', 'verified', 'xss', 'checkUserStatus']], function () {
    ...
    Route::group(['middleware' => ['role:Admin|Nurse|Accountant|Receptionist']], function () {
    ...
    Route::group(['middleware' => ['role:Admin|Receptionist|Accountant']], function () {
    ...
    Route::group(['middleware' => ['role:Admin|Doctor|Receptionist|Lab Technician|Pharmacist']], function () {
        ...
        Route::get('radiology-test/{radiologyTest}/pdf',
            'RadiologyTestController@convertToPdf')->name('radiology.test.pdf');
        ...
        Route::get('pathology-test/{pathologyTest}/pdf',
            'PathologyTestController@convertToPdf')->name('pathology.test.pdf');
    });

    Route::group(['middleware' => ['role:Admin|Nurse|Receptionist']], function () {
    ...
    Route::group(['middleware' => ['role:Admin']], function () {
        ...
        //ROLES 
        Route::get('departments', 'DepartmentController@index')->name('departments.index')->middleware('modules');
        ...
        Route::post('departments/{department}/active-deactive', 'DepartmentController@activeDeactiveDepartment')->name('departments.department');
