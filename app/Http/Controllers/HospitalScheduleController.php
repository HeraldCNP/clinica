...
class HospitalScheduleController extends AppBaseController
{
    ...
    public function store(Request $request)
    {
        ...
        if (isset($input['checked_week_days'])) {
            ...
            return $this->sendSuccess('Horario registrado/actualizado con éxito.');
        }
    ...
    {
        $input = $request->all();
        $message = 'Algunos médicos han programado sus días en días no marcados, ¿está seguro de que desea realizar esta operación?';
        if (isset($input['checked_week_days'])) {
