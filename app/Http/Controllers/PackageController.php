...
class PackageController extends AppBaseController
{
    ...
    public function create()
    {
        ...
        return view('packages.create', compact('patients', 'services', 'servicesList'));
    }
    ...
    public function store(CreatePackageRequest $request)
    {
        ...
        return $this->sendResponse($package, 'Servicio registrado con éxito.');
    }
    ...
    public function edit(Package $package)
    {
        ...
        return view('packages.edit', compact('patients', 'services', 'package', 'servicesList'));
    }
    ...
    public function update(Package $package, UpdatePackageRequest $request)
    {
        ...
        return $this->sendResponse($package, 'Servicio actualizado con éxito.');
    }
