...
class WebController extends Controller
{
    ...
    public function index()
    {
        ...
        $totalNurseReceptionists = Nurse::count() + Receptionist::count();
        ...
        return view('web.home.index',
            compact('doctorsDepartments', 'doctors', 'todayNotice', 'testimonials', 'totalbeds',
                'totalDoctor', 'totalPatient', 'totalNurseReceptionists', 'doctorAppointments', 'frontSetting', 'frontServices'));
    }
    ...
    public function aboutUs()
    {
        ...
        return view('web.home.about_us',
            compact('frontSetting', 'totalbeds', 'totalDoctor', 'totalPatient', 'totalNurseReceptionists', 'testimonials', 'doctors'));
    }
