...
class ScheduleController extends AppBaseController
{
    ...
    public function create()
    {
        ...
        if (count($hospitalSchedules) == 0) {
            Flash::success('Actualmente, el usuario no puede crear un horario del centro, si el horario del centro no está disponible');
        }
    ...
    public function store(CreateScheduleRequest $request)
    {
        ...
        Flash::success('Horario registrado con éxito.');
    ...
    public function update(Schedule $schedule, UpdateScheduleRequest $request)
    {
        ...
        Flash::success('Horario actualizado con éxito.');
    ...
    public function doctorScheduleList(Request $request)
    {
        ...
        if (! $check) {
            return $this->sendError('El centro hoy día está cerrado.');
        }
