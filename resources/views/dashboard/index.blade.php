        ...
        <div id="kt_content_container" class="container">
            <div class="row g-5 gx-xxl-8 justify-content-center">
                ...
                @if($modules['Doctors'] == true)
                    {{-- Doctors Widget --}}
                    <div class="col-xl-3 col-md-6">
                        <a href="{{ route('doctors.index') }}" class="card bg-success hoverable card-xl-stretch mb-xl-8">
                        <!--<a href="{{ route('doctors.index') }}"
                           class="card bg-secondary hoverable card-xl-stretch mb-xl-8">-->
                            <div class="card-body card-5">
                                <span class="rotate"><i class="fas fa-user-md fa-4x display-4 card-icon text-white"></i></span>
                                <div
                                    class="text-inverse-warning fw-bolder card-count fs-2 mb-2 mt-5 amount-position">{{ $data['doctors'] }}</div>
                                <div
                                    class="fw-bold text-inverse-warning fs-7">{{ __('messages.dashboard.doctors') }}</div>
                            </div>
                        </a>
                    </div>
                @endif
                        ...
                        <a href="{{ route('patients.index') }}"
                           class="card bg-primary hoverable card-xl-stretch mb-xl-8">
                            <div class="card-body card-6">
                                <span class="rotate"><i
                                        class="fas fa-user-injured fa-4x display-4 card-icon text-white"></i></span>
                                <div
                        ...
                        <a href="{{ route('receptionists.index') }}"
                           class="card bg-warning hoverable card-xl-stretch mb-xl-8">
                            <div class="card-body card-8">
                                <span class="rotate"><i
                                        class="fas fa-user-tie fa-4x display-4 card-icon text-white"></i></span>
                                <div
                                    class="text-inverse-dark fw-bolder card-count fs-2 mb-2 mt-5 amount-position">{{ $data['receptionists'] }}</div>
                                <div class="fw-bold text-inverse-dark fs-7">{{ __('messages.receptionists') }}</div>
                            </div>
                        </a>
                    </div>
                @endif
                @if($modules['Cases'] == true)
                    {{-- Cases Widget --}}
                    <div class="col-xl-3 col-md-6">
                        <a href="{{ route('patient-cases.index') }}"
                           class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                            <div class="card-body card-9">
                                <span class="rotate"><i
                                        class="fas fa-briefcase-medical fa-4x display-4 card-icon text-white"></i></span>
                                <div
                                    class="text-inverse-dark fw-bolder card-count fs-2 mb-2 mt-5 amount-position">{{ $data['cases'] }}</div>
                                <div class="fw-bold text-inverse-dark fs-7">{{-- __('messages.cases') --}}{{ __('Casos') }}</div>
                            </div>
                        </a>
                    </div>
                @endif
                @if($modules['Appointments'] == true)
                    {{-- Appointments Widget --}}
                    <div class="col-xl-3 col-md-6">
                        <a href="{{ route('appointments.index') }}"
                           class="card bg-secondary hoverable card-xl-stretch mb-xl-8">
                            <div class="card-body card-10">
                                <span class="rotate"><i
                                        class="fas fa-calendar-check fa-4x display-4 card-icon text-blue"></i></span>
                                <div
                                    class="text-inverse-secondary fw-bolder card-count fs-2 mb-2 mt-5 amount-position">{{ $data['appointments'] }}</div>
                                <div class="fw-bold text-inverse-secondary fs-7">{{ __('messages.appointments') }}</div>
                            </div>
                        </a>
                    </div>
                @endif
                @if($modules['Diagnosis Tests'] == true)
                    {{-- Diagnosis Tests Widget --}}
                    <div class="col-xl-3 col-md-6">
                        <a href="{{ route('patient.diagnosis.test.index') }}"
                           class="card bg-success hoverable card-xl-stretch mb-xl-8">
                            <div class="card-body card-10">
                                <span class="rotate"><i
                                        class="fas fa-stethoscope fa-4x display-4 card-icon text-white"></i></span>
                                <div
                                    class="text-inverse-dark fw-bolder card-count fs-2 mb-2 mt-5 amount-position">{{ $data['diagnosisTests'] }}</div>
                                <div class="fw-bold text-inverse-dark fs-7">{{-- __('messages.diagnosis_tests') --}}{{ 'Exámenes' }}</div>
                            </div>
                        </a>
                    </div>
                @endif
                @if($modules['IPD Patients'] == true)
                    {{-- IPD Patients Widget --}}
                    <div class="col-xl-3 col-md-6">
                        <a href="{{ route('ipd.patient.index') }}"
                           class="card bg-info hoverable card-xl-stretch mb-xl-8">
                            <div class="card-body card-10">
                                <span class="rotate"><i
                                        class="fas fa-notes-medical fa-4x display-4 card-icon text-white"></i></span>
                                <div
                                    class="text-inverse-dark fw-bolder card-count fs-2 mb-2 mt-5 amount-position">{{ $data['ipdPatients'] }}</div>
                                <div class="fw-bold text-inverse-dark fs-7">{{-- __('messages.ipd') --}}{{ 'Historiales' }}</div>
                            </div>
                        </a>
                    </div>
                @endif
                    ...
                    <div class="card card-xxl-stretch mb-5 mb-xxl-8">
                        ...
                        <div class="card-body py-3">
                            <div class="table-responsive">
                                ...
                                @else
                                    <h2 class="text-center">No hay consultas todavía...</h2>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-xxl-stretch mb-5 mb-xxl-8">
                        ...
                        <div class="card-body py-3">
                            <div class="table-responsive">
                                ...
                                @else
                                    <h2 class="text-center">Aún no hay anuncios...</h2>
                                @endif
                            </div>
                        </div>
                    </div>
