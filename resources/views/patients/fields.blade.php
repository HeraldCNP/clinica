...
<div class="row gx-10 mb-5">
    ...
    <div class="col-md-4">
        <div class="form-group mb-5">
            {{ Form::label('ci', __('messages.user.ci').':', ['class' => 'form-label fs-6 fw-bolder text-gray-700 mb-3']) }}<span class="required"></span>
            {{ Form::text('ci', null, ['class' => 'form-control form-control-solid', 'required','placeholder'=>'Número de carnet']) }}
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group mb-5">
            {{ Form::label('occupation', __('messages.user.occupation').':', ['class' => 'form-label fs-6 fw-bolder text-gray-700 mb-3']) }}
            {{ Form::text('occupation', null, ['class' => 'form-control form-control-solid']) }}
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group mb-5">
            {{ Form::label('blood_group', __('messages.user.blood_group').':', ['class' => 'form-label fs-6 fw-bolder text-gray-700 mb-3']) }}
            {{ Form::select('blood_group', $bloodGroup, null, ['class' => 'form-select form-select-solid fw-bold', 'id' => 'bloodGroup', 'placeholder' => 'Seleccionar Grupo', 'data-control' => 'select2', 'tabindex' => "9"]) }}
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group mb-5">
    ...
    <div class="col-md-4">
        <div class="form-group mb-5">
            ...
            {{ Form::password('password', ['class' => 'form-control form-control-solid', 'min' => '6','max' => '10', 'tabindex' => '10']) }}
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group mb-5">
            {{ Form::label('password_confirmation', __('messages.user.password_confirmation').':', ['class' => 'form-label fs-6 fw-bolder text-gray-700 mb-3']) }}<!--<span class="required"></span>-->
            {{ Form::password('password_confirmation', ['class' => 'form-control form-control-solid', 'min' => '6','max' => '10', 'tabindex' => '11']) }}
        </div>
    </div>
    <div class="col-md-4">
