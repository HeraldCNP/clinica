        ...
        <div class="card-body pt-9 pb-0">
                ...
                <div class="flex-grow-1">
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        ...
                        <div class="d-flex col-12">
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                <div class="d-flex align-items-center"><i class="fas fa-file fa-2x me-2 text-warning"></i>
                                    <div class="fs-2 fw-bolder text-gray-800" data-kt-countup="true" data-kt-countup-value="{{!empty($data->documents) ? $data->documents->count() : ''}}">
                                        0
                                    </div>
                                </div>
                                <div class="fw-bold fs-6 text-gray-400">{{__('messages.patient.total_documents')}}</div>
                            </div>
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                <div class="d-flex align-items-center"><i class="fas fa-calendar-check fa-2x me-2 text-primary"></i>
            ...
            <div class="d-flex overflow-auto h-55px">
                <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
                    <li class="nav-item">
                        <a class="nav-link text-active-primary me-6 active" data-bs-toggle="tab" href="#poverview">Datos</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="card mb-5 mb-xl-10">
                <div class="card-header border-0">
                    <div class="card-title m-0">
                        <h3 class="fw-bolder m-0">Detalle Específico</h3>
                    </div>
                </div>
                <div>
                    <div class="card-body  border-top p-9">
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8">
                                <span
                                    class="fw-bolder fs-6 text-gray-800 me-2">{{ !empty($data->user->dob) ? \Carbon\Carbon::parse($data->user->dob)->format('j M, Y') : __('messages.common.n/a') }}</span>
                            </div>
                        </div>
                        <div class="row mb-7">
                            <label class="col-lg-4 fw-bold text-muted">{{ __('messages.user.ci') }}</label>
                            <div class="col-lg-8">
                                <span
                                    class="fw-bolder fs-6 text-gray-800 me-2">{{ ($data->user->ci) }}</span>
                            </div>
                        </div>
                        <div class="row mb-7">
                            <label class="col-lg-4 fw-bold text-muted">{{ __('messages.user.occupation') }}</label>
                            <div class="col-lg-8">
                                <span
                                    class="fw-bolder fs-6 text-gray-800 me-2">{{ ($data->user->occupation) ? $data->user->phone :__('messages.common.n/a') }}</span>
                            </div>
                        </div>
                        <div class="row mb-7">
                                            ...
                                            <tr>
                                                ...
                                                <td class="word-nowrap">
                                                        <div class="badge badge-light">
                                                            ...
                                                            <div>{{ \Carbon\Carbon::parse($case->date)->format('j M, Y') }}</div>
                                                        </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="badge badge-light">
                                                        ...
                                                        <div>{{ \Carbon\Carbon::parse($admission->admission_date)->format('j M, Y') }}</div>
                                                    </div>
                                                </td>
                                                <td>
                                                    @if(!empty($admission->discharge_date))
                                                        <div class="badge badge-light">
                                                            ...
                                                            <div>{{ \Carbon\Carbon::parse($admission->discharge_date)->format('j M, Y') }}</div>
                                                        </div>
                                                    @else
                                                        N/A
                                                    @endif
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="badge badge-light">
                                                        ...
                                                        <div>{{ \Carbon\Carbon::parse($appointment->opd_date)->format('j M, Y') }}</div>
                                                    </div>
                                                </td>
                                                @if(!Auth::user()->hasRole('Patient|Doctor|Accountant|Case Manager'))
