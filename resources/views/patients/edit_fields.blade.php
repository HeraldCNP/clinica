...
<div class="row gx-10 mb-5">
    ...
    <div class="col-md-4">
        <div class="form-group mb-5">
            ...
            {{ Form::select('blood_group', $bloodGroup, null, ['class' => 'form-select form-select-solid', 'id' => 'bloodGroup', 'placeholder' => 'Seleccionar Grupo', 'data-control' => 'select2', 'tabindex' => "9"]) }}
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group mb-5">
