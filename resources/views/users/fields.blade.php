<div class="row gx-10 mb-5">
    <div class="col-lg-4">
        ...
        <div class="mb-5">
            {{ Form::label('ci', __('messages.user.ci').':', ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
            {{ Form::text('ci', null, ['class' => 'form-control form-control-solid', 'required', 'tabindex' => '1','placeholder'=>'Número de carnet']) }}
        </div>
    ...
    <div class="col-lg-4">
        ...
        @if(!$isEdit)
            <div class="mb-5">
                ...
                {{ Form::select('department_id', $role, null, ['class' => 'form-select form-select-solid fw-bold', 'required', 'id' => 'role', 'placeholder' => 'Seleccionar Rol', 'data-control' => 'select2']) }}
            </div>
        @endif
        ...
        <div class="col-lg-5">
            ...
            <div class="image-input image-input-outline" data-kt-image-input="true" style="">
                ...
                <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-white shadow"
                       ...
                       data-bs-original-title="Cambiar avatar">
                ...
                <span class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-white shadow"
                      ...
                      data-bs-original-title="Remover avatar">
                ...
                <span
                        ...
                        data-bs-original-title="Remover avatar"><i class="bi bi-x fs-2"></i></span>
            </div>
