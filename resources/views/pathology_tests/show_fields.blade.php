                    ...
                    <div class="card-body  border-top p-9">
                        <div class="row mb-7">
                            <div class="col-lg-4 d-flex flex-column">
                                <label class="fw-bold text-muted py-3">{{ __('messages.pathology_test.patient')  }}</label>
                                <span class="fw-bolder fs-6 text-gray-800">{{$pathologyTest->patient->user->full_name}}</span>
                            </div>
                            <div class="col-lg-4 d-flex flex-column">
                                <label class="fw-bold text-muted py-3">{{ __('messages.pathology_test.doctor')  }}</label>
                                <span class="fw-bolder fs-6 text-gray-800">{{$pathologyTest->doctor->user->full_name}}</span>
                            </div>
                            <div class="col-lg-4 d-flex flex-column">
                            ...
                            <!--<div class="col-lg-4 d-flex flex-column">
                                ...
                                <span class="fw-bolder fs-6 text-gray-800">{{$pathologyTest->chargecategory}}</span>
                            </div>-->
                            <!--<div class="col-lg-4 d-flex flex-column">
