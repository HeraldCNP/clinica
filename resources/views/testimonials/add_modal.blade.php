    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2>{{-- __('messages.testimonial.new_testimonial') --}} {{ __('Registrar Testimonio') }}</h2>
                    ...
                    <div class="form-group col-sm-12 mb-5">
                        <label class="form-label required fs-6 fw-bolder text-gray-700 mb-3" for="file"> <span>{{__('messages.common.profile')}}: </span>
                            <i class="fa fa-question-circle ms-1 fs-7" data-bs-toggle="tooltip"
                               title="La mejor resolución para este perfil será 150x150"></i>
                        </label>
                        <br>
                        <div class="image-input image-input-outline" data-kt-image-input="true" style="">
                            ...
                            <label
                                    ...
                                    data-bs-original-title="Cambiar perfil">
                            ...
                            <span class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-white shadow"
                                  ...
                                  data-bs-original-title="Cancelar perfil">
