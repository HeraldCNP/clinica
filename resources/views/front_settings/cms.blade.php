                    ...
                    <div class="row2">
                        <label class="form-label required fs-6 fw-bolder text-gray-700 mb-3 d-block"
                            ...
                            <i class="fa fa-question-circle ms-1 fs-7" data-bs-toggle="tooltip"
                               title="La mejor resolución para este perfil será 735x850"></i>
                        </label>
                        <div class="image-input image-input-outline" data-kt-image-input="true">
                            ...
                            <label
                                    ...
                                    data-bs-original-title="Cambiar imagen">
                            ...
                            <span class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-white shadow"
                                  ...
                                  data-bs-original-title="Cancelar imagen">
                ...
                <div class="form-group col-sm-6 mb-5">
                    <div class="row2">
                        <label class="form-label required fs-6 fw-bolder text-gray-700 mb-3 d-block"
                            ...
                            <i class="fa fa-question-circle ms-1 fs-7" data-bs-toggle="tooltip"
                               title="La mejor resolución para este perfil será 636x708"></i>
                        </label>
                        <div class="image-input image-input-outline" data-kt-image-input="true">
                            <div class="image-input-wrapper w-125px h-125px bgi-position-center" id="previewImage"
