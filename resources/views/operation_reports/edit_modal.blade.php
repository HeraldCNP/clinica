                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group mb-5">
                            ...
                            {{ Form::select('case_id', $cases, null, ['class' => 'form-select form-select-solid','required','id' => 'editCaseId','placeholder'=>'Seleccionar Caso']) }}
                        </div>
                    </div>
                    ...
                    @else
                        <div class="col-md-12">
                            <div class="form-group mb-5">
                                ...
                                {{ Form::select('doctor_id', $doctors, null, ['class' => 'form-select form-select-solid','required','id' => 'editDoctorId','placeholder'=>'Seleccionar Médico']) }}
                            </div>
                        </div>
                    @endif
                    <div class="col-md-12">
