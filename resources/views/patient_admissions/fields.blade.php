<div class="row">
    ...
    <div class="form-group mb-5 col-sm-4">
        ...
        {{ Form::select('patient_id', $data['patients'], null, ['class' => 'form-select form-select-solid select2Selector','id' => 'patientId', 'placeholder' => 'Seleccionar Paciente','data-control' => 'select2','required',isset($patientAdmission->patient_admission_id) ? 'disabled' : '']) }}
    ...
    @else
        <div class="form-group mb-5 col-sm-4">
            ...
            {{ Form::select('doctor_id',$data['doctors'], null, ['class' => 'form-select form-select-solid select2Selector','id' => 'doctorId', 'placeholder' => 'Seleccionar Médico','data-control' => 'select2','required']) }}
        </div>
@endif
...
@isset($patientAdmission)
    <!-- Discharge Date Field -->
        <div class="form-group mb-5 col-sm-4 date-container">
...
<!-- Package Id Field -->
    ...
    <div class="form-group mb-5 col-sm-4">
        ...
        {{ Form::select('insurance_id', $data['insurances'], null, ['class' => 'form-select form-select-solid select2Selector','id' => 'insuranceId', 'placeholder' => 'Seleccionar Seguro','data-control' => 'select2']) }}
    </div>
    ...
    <div class="form-group mb-5 col-sm-4 mb-5">
