<div class="row">
    ...
    @else
        <div class="form-group col-sm-4 mb-5">
            ...
            {{ Form::select('patient_id', $patients, null, ['class' => 'form-select form-select-solid','required','id' => 'patientId','placeholder'=>'Seleccionar Paciente', 'data-control' => 'select2']) }}
        </div>
    @endif
<!-- Department Name Field -->
    <div class="form-group col-sm-4 mb-5">
        ...
        {{ Form::select('department_id',$departments, null, ['class' => 'form-select form-select-solid','required','id' => 'departmentId','placeholder'=>'Seleccionar Especialidad', 'data-control' => 'select2']) }}
    </div>
    <!-- Doctor Name Field -->
    <div class="form-group col-sm-4 mb-5">
        {{ Form::label('doctor_name', __('messages.case.doctor').':', ['class' => 'form-label fs-6 required fw-bolder text-gray-700 mb-3']) }}
        {{ Form::select('doctor_id',(isset($doctors) ? $doctors : []), null, ['class' => 'form-select form-select-solid','required','id' => 'doctorId','placeholder'=>'Seleccionar Médico', 'data-control' => 'select2']) }}
    </div>
