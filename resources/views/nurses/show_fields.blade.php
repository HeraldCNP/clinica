            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div>
                    <div class="card-body  border-top p-9">
                        <div class="row mb-7">
                            <label class="col-lg-4 fw-bold text-muted">{{ __('Nombre completo')  }}</label>
                            <div class="col-lg-8">
                        ...
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8">
                                <span class="fw-bolder fs-6 text-gray-800">{{ !empty($nurse->user->dob) ? \Carbon\Carbon::parse($nurse->user->dob)->format('j M, Y') : __('messages.common.n/a') }}</span>
                            </div>
                        </div>
                        <div class="row mb-7">
                        ...
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8">
                                <span class="fw-bolder fs-6 text-gray-800">{{ $nurse->user->gender == 0 ? 'Masculino' : 'Femenino' }}</span>
                            </div>
                        </div>
                        <!--<div class="row mb-7">
