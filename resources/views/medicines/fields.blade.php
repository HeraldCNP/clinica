...
<div class="form-group col-md-4 mb-5">
    ...
    <span class="required"></span>
    {{ Form::select('category_id', $categories, (isset($medicine)) ? $medicine->category_id : null, ['class' => 'form-select form-select-solid', 'placeholder' => 'Seleccionar Categoría', 'id' => 'categoryId']) }}
</div>
...
<div class="form-group col-md-4 mb-5">
    ...
    <span class="required"></span>
    {{ Form::select('brand_id', $brands,  (isset($medicine)) ? $medicine->brand_id : null, ['class' => 'form-select form-select-solid', 'placeholder' => 'Seleccionar Marca', 'id' => 'brandId']) }}
</div>
