        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-lg-5 col-md-12">
                    <div class="main-banner-content-with-search" data-speed="0.06" data-revert="true"><br><br><br>
                        ...
                        <p data-aos="fade-up" data-aos-delay="80"
                           data-aos-duration="800">{{ \Illuminate\Support\Str::limit($frontSetting['home_page_description'], 250) }}</p>
                    </div><br><br>
                    @if(!Auth::user())
            ...
            <div class="row justify-content-center">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-solutions-card">
                        ...
                        <h3>
                            <a href="javascript:void(0)">{{ \Illuminate\Support\Str::limit($frontSetting['home_page_step_1_title'], 40) }}</a>
                        </h3>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-solutions-card">
                        ...
                        <h3>
                            <a href="javascript:void(0)">{{ \Illuminate\Support\Str::limit($frontSetting['home_page_step_2_title'], 40) }}</a>
                        </h3>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-solutions-card">
                        ...
                        <h3>
                            <a href="javascript:void(0)">{{ \Illuminate\Support\Str::limit($frontSetting['home_page_step_3_title'], 40) }}</a>
                        </h3>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-solutions-card">
                        ...
                        <h3>
                            <a href="javascript:void(0)">{{ \Illuminate\Support\Str::limit($frontSetting['home_page_step_4_title'], 40) }}</a>
                        </h3>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="choose-fun-fact test">
                                    ...
                                    <p>{{ __('messages.web_home.patients') }}</p>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="choose-fun-fact bg-ef720c">
                                    <h3>
                                        <span class="odometer" data-count="{{ $totalDoctor }}">00</span>
                                    </h3>
                                    <p>{{ __('messages.web_home.doctors') }}</p>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="choose-fun-fact bg-ed2f16">
                                    <h3>
                                        <span class="odometer" data-count="{{ $totalNurseReceptionists }}">00</span>
                                    </h3>
                                    <p>{{ __('messages.web_home.nurses_receptionists') }}</p>
                                </div>
                            </div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="healthcare-doctor-image" data-speed="0.05" data-revert="true">
                        ...
                        <div class="healthcare-card-content">
                            ...
                            <h3>{{ \Illuminate\Support\Str::limit($frontSetting['home_page_certified_box_title'], 20) }}</h3>
                            <p>{{ \Illuminate\Support\Str::limit($frontSetting['home_page_certified_box_description'], 50) }}</p>
                        </div>
                    </div>
                </div>
            </div>
