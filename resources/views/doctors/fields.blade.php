...
<div class="row">
    ...
    <div class="form-group col-sm-4  mb-5">
        ...
        {{ Form::select('doctor_department_id', $doctorsDepartments, null, ['class' => 'form-select form-select-solid', 'id' => 'doctorDepartmentId', 'placeholder' => 'Seleccionar Especialidad', 'data-control' => 'select2','required']) }}
    </div>
    <div class="col-md-4">
        <div class="form-group mb-5">
        ...
        <div class="row2">
            <label class="fs-5 fw-bold mb-2 d-block" for="image"> <span>{{__('messages.profile.profile')}}: </span>
                <i class="fa fa-question-circle ms-1 fs-7" data-bs-toggle="tooltip"
                   title="La mejor resolución para este perfil será 325x375"></i>
            </label>
