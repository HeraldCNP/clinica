            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::select('case_id', $cases, null, ['class' => 'form-select form-select-solid','required','id' => 'caseId','placeholder'=>'Seleccionar Caso']) }}
                    </div>
                    ...
                    @else
                        <div class="form-group col-sm-12 mb-5">
                            ...
                            {{ Form::select('doctor_id',$doctors, null, ['class' => 'form-select form-select-solid','required','id' => 'doctorId','placeholder'=>'Seleccionar Médico']) }}
                        </div>
                    @endif
                    <div class="form-group col-sm-12 mb-5">
