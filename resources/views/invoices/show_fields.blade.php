<div class="flex-lg-row-fluid me-xl-18 mb-10 mb-xl-0">
    <div class="mt-n1">
        ...
        <div class="m-0">
            <div class="fw-bolder fs-3 text-gray-800 mb-8">Recibo #&nbsp{{ $invoice->invoice_id }}</div>
            <div class="row g-5 mb-11">
                <div class="col-sm-6">
                    <div class="fw-bold fs-7 text-gray-600 mb-1">{{ __('messages.invoice.invoice_date').':' }}</div>
                    <div
                        class="fw-bolder fs-6 text-gray-800">{{ \Carbon\Carbon::parse($invoice->invoice_date)->format('j M, Y') }}</div>
                </div>
            </div>
            <div class="row g-5 mb-12">
                <div class="col-sm-6">
                    <div class="fw-bold fs-7 text-gray-600 mb-1">Recibo para:</div>
                ...
                <div class="col-sm-6">
                    <div class="fw-bold fs-7 text-gray-600 mb-1">Emitido por:</div>
...
<div class="m-0">
    <div class="d-print-none border border-dashed border-gray-300 card-rounded h-lg-100 min-w-md-350px p-9 bg-lighten">
        ...
        <h6 class="mb-8 fw-boldest text-gray-600 text-hover-primary">DETALLE ESPECÍFICO DEL PACIENTE</h6>
        <div class="mb-6">
