    ...
    <div class="d-flex flex-column align-items-start flex-xxl-row">
        <div class="d-flex align-items-center flex-equal fw-row me-4 order-2">
            <div class="">
                ...
                {{ Form::select('patient_id', $patients, isset($invoice) ? $invoice->patient_id : null, ['class' => 'form-select form-select-solid fw-select', 'id' => 'patient_id', 'placeholder' => 'Seleccionar Paciente','required','data-control' =>'select2']) }}
            </div>
        </div>
        ...
        <div class="d-flex flex-center flex-equal fw-row text-nowrap order-1 order-xxl-2 me-4" data-bs-toggle="tooltip" data-bs-trigger="hover" title="" data-bs-original-title="invoice number">
            <span class="fs-2x fw-bolder text-gray-800">Recibo #&nbsp</span>
        ...
        <div class="row gx-10 mb-5">
            <div class="col-lg-4 col-sm-12">
                <div class="mb-5">
                    ...
                    (%)
                    {{ Form::number('discount',  isset($invoice) ? $invoice->discount : null, ['id'=>'discount','class' => 'form-control form-control-solid','placeholder' => 'En porcentaje','required', 'min' => 0, 'max' => 100, 'step' => '.01']) }}
                </div>
            </div>
            <div class="col-lg-4 col-sm-12">
                <div class="mb-5">
