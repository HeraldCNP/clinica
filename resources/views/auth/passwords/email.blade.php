            ...
            <div class="w-lg-500px bg-white rounded shadow-sm p-10 p-lg-15 mx-auto">
                <form method="post" class="form w-100 form-submit" action="{{ url('/password/email') }}">
                    ...
                    <div class="text-center mb-10">
                        ...
                        <div class="text-gray-400 fw-bold fs-4">Ingrese su correo electrónico para restablecer su contraseña.</div>
                    </div>
                    ...
                    <div class="d-flex justify-content-center pb-lg-0">
                        <button type="submit" id="kt_password_reset_submit"
                            ...
                            <span class="indicator-label">Enviar enlace de restablecimiento de contraseña</span>
