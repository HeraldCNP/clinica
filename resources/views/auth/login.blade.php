            ...
            <div class="w-lg-500px bg-white rounded shadow-sm p-10 p-lg-15 mx-auto">
                <form method="post" class="form w-100 form-submit" action="{{ url('/login') }}" id="kt_sign_in_form">
                    ...
                    <div class="text-center mb-10">
                        <!--<h1 class="text-dark mb-3">Registrarse</h1>-->
                        <h1 class="text-primary mb-3">CENTRO MÉDICO "VITAL"</h1>
                        <h1 class="text-gray-700 mb-3">Acceso</h1>
                    ...
                    <div class="fv-row mb-10">
                        <div class="d-flex flex-stack mb-2">
                            ...
                            <a href="{{ url('/password/reset') }}" class="link-primary fs-6 fw-bolder">Has olvidado tu contraseña
                                ?</a>
                        </div>
                        <input type="password"
                    ...
                    <div class="fv-row mb-10">
                        <label class="form-check form-check-custom form-check-solid form-check-inline"
                            ...
                            <span class="form-check-label fw-bold text-gray-700 fs-6">Recordarme</span>
                        </label>
                    </div>
