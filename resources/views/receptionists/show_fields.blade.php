        ...
        <div class="card-body pt-9 pb-0">
            ...
            <div class="d-flex overflow-auto h-55px">
                <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
                    <li class="nav-item">
                        <a class="nav-link text-active-primary me-6 active" data-bs-toggle="tab" href="#roverview">Datos</a>
                    </li>
                    <!--<li class="nav-item">
                ...
                <div>
                    <div class="card-body  border-top p-9">
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8">
                                <span class="fw-bolder fs-6 text-gray-800">{{ !empty($receptionist->user->dob) ? \Carbon\Carbon::parse($receptionist->user->dob)->format('j M, Y') : __('messages.common.n/a') }}</span>
                            </div>
                        </div>
                        <div class="row mb-7">
                        ...
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8">
                                <span class="fw-bolder fs-6 text-gray-800">{{ $receptionist->user->gender == 0 ? 'Masculino' : 'Femenino' }}</span>
                            </div>
                        </div>
                        <!--<div class="row mb-7">
