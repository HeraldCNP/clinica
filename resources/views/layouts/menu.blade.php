...
<div class="position-relative mb-5 mx-3 mt-2 sidebar-search-box">
    ...
    <input type="text" class="form-control form-control-lg form-control-solid ps-15" id="menuSearch" name="search"
           value="" placeholder="Búsqueda" style="background-color: #2A2B3A;border: none;color: #FFFFFF"
           autocomplete="off">
</div>
<div class="no-record text-white text-center d-none">No se encontraron registros coincidentes</div>
@role('Admin')
{{--Dashboard--}}
...
@if ($patientCaseMgt)
    <div class="menu-item menu-accordion side-menus">
        <a class="menu-link menu-text-wrap {{ Request::is('patients*','patient-cases*','case-handlers*') ? 'active' : '' }}"
           href="{{ $patientCaseMgt }}">
...
@if ($serviceMgt)
    <div class="menu-item menu-accordion side-menus">
        <a class="menu-link menu-text-wrap {{ Request::is('packages*','services*','ambulances*','ambulance-calls*') ? 'active' : '' }}"
           href="{{ $serviceMgt }}">
...
{{-- Insurances dropdown --}}
    <?php
    $receptionistInsuranceMgt = getMenuLinks(\App\Models\User::MAIN_INSURANCE)
    ?>
    @if ($receptionistInsuranceMgt)
        <div class="menu-item menu-accordion side-menus">
            <a class="menu-link menu-text-wrap {{ Request::is('insurances*','patient-admissions*') ? 'active' : '' }}"
               href="{{ $receptionistInsuranceMgt }}">
                ...
                <span class="d-none">{{__('messages.patient-admissions')}}</span>
            </a>
        </div>
    @endif
...
@if(Auth::user()->email_verified_at != null)
    ...
    @if ($patientCaseMgt)
        <div class="menu-item menu-accordion side-menus">
            <a class="menu-link menu-text-wrap {{ Request::is('patients*') ? 'active' : '' }}"
               href="{{ $patientCaseMgt }}">
                <span class="menu-icon"><i class="fas fa-user-injured"></i></span>
                <span class="menu-title">{{ __('messages.patients') }}</span>
            </a>
    ...
    <div class="menu-item side-menus">
        <a class="menu-link menu-text-wrap {{ Request::is('employee/notice-board*') ? 'active' : '' }}"
           href="{{ url('employee/notice-board') }}">
            <span class="menu-icon"><i class="fas fa fa-clipboard"></i></span>
...
@endrole
    ...
    @if ($serviceMgt)
        <div class="menu-item menu-accordion side-menus">
            <a class="menu-link menu-text-wrap {{ Request::is('packages*','services*') ? 'active' : '' }}"
               href="{{ $serviceMgt }}">
                <span class="menu-icon"><i class="fas fa-syringe"></i></span>
                <span class="menu-title">{{ __('messages.services') }}</span>
                <span class="d-none">{{__('messages.packages')}}</span>
