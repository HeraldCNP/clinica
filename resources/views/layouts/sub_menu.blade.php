...
<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch {{ (!Request::is('users*')) ? 'd-none' : '' }}"
    ...
    @module('Departments',$modules)
    <div class="menu-item me-lg-1 {{ Request::is('departments*') ? 'show' : ''  }}">
        <a class="menu-link py-3 "
           href="{{ route('departments.index') }}">
            <span class="menu-title">{{ __('messages.departments') }}</span>
        </a>
    </div>
    @endmodule
    @endrole
...
<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch {{ (!Request::is('patients*','patient-cases*','case-handlers*')) ? 'd-none' : '' }}"
    id="#kt_header_menu" data-kt-menu="true">
...
<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch {{ (!Request::is('packages*','services*','ambulances*','ambulance-calls*')) ? 'd-none' : '' }}"
    id="#kt_header_menu" data-kt-menu="true">
    @role('Admin|Nurse|Accountant')
...
<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch {{ (!Request::is('insurances*','patient-admissions*','ambulances*','ambulance-calls*')) ? 'd-none' : '' }}"
    id="#kt_header_menu" data-kt-menu="true">
    @role('Admin|Receptionist')
