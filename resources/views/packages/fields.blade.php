<div class="row">
    <div class="col-md-4 col-sm-6">
        <div class="form-group mb-5">
            {{ Form::label('patient_name', __('messages.package.patient').(':'),['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
            {{ Form::select('patient_id', $patients, null, ['class' => 'form-select form-select-solid', 'required', 'id' => 'patientId', 'placeholder' => 'Seleccionar Paciente']) }}
        </div>
    </div>
    <div class="col-md-4 col-sm-6">
        <div class="form-group mb-5">
    ...
    <div class="col-md-4 col-sm-6">
        <div class="form-group mb-5">
            ...
            (%)
            {{ Form::number('discount',  null, ['id'=>'discountId','class' => 'form-control form-control-solid discount', 'min' => 0, 'max' => 100, 'step' => '.01', 'placeholder' => 'En porcentaje', 'required']) }}
        </div>
    </div>
    <div class="col-md-8">
        <div class="form-group mb-5">
