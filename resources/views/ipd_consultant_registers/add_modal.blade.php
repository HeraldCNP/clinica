                        ...
                        <table class="table g-5 gs-0 mb-0 fw-bolder text-gray-700"
                            ...
                            <tr>
                                ...
                                <td class="consultant-table-td">
                                    {{ Form::select('doctor_id[]', $doctors, null, ['class' => 'form-select form-select-solid doctorId select2Selector','required','placeholder'=>'Seleccionar Médico']) }}
                                </td>
                                <td class="consultant-table-td position-relative">
