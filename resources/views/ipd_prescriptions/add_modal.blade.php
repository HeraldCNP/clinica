                    ...
                    <div class="col-sm-12 overflow-auto">
                        ...
                        <table class="table g-5 gs-0 mb-0 fw-bolder text-gray-700" id="ipdPrescriptionTbl">
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ Form::select('category_id[]', $medicineCategories, null, ['class' => 'form-select form-select-solid categoryId select2Selector','required','placeholder'=>'Seleccionar Categoría', 'data-id' => '1']) }}
                                </td>
                                <td>
