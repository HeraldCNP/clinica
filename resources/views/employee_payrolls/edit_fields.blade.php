<div class="row gx-10 mb-5">
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 mb-5 myclass">
        ...
        {{ Form::select('type', $types, $employeePayroll->type, ['id' => 'type','class' => 'form-select form-select-solid fw-bold', 'required','placeholder' => 'Seleccionar Rol','data-control' => 'select2']) }}
    </div>
    <div class="col-lg-4 col-md-4 col-sm-12 mb-5">
