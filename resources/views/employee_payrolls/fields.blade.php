<div class="row gx-10 mb-5">
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 mb-5 myclass">
        {{ Form::label('type',__('messages.employee_payroll.role').':', ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
        {{ Form::select('type', $types, null, ['id' => 'type','class' => 'form-select form-select-solid fw-bold', 'required','placeholder' => 'Seleccionar Rol','data-control' => 'select2']) }}
    </div>
    <div class="col-lg-4 col-md-4 col-sm-12 mb-5">
        {{ Form::label('owner_id',__('messages.employee_payroll.employee').':', ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
        {{ Form::select('owner_id', [], null, ['id' => 'ownerType','class' => 'form-select form-select-solid fw-bold','required','disabled','data-control' => 'select2', 'placeholder' => 'Seleccionar Empleado']) }}
    </div>
    <div class="col-lg-4 col-md-4 col-sm-12 mb-5">
