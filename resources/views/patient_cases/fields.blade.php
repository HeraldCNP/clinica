<div class="row">
    <div class="form-group col-sm-4 mb-5">
        ...
        {{ Form::select('patient_id', $patients, null, ['class' => 'form-select form-select-solid select2Selector', 'required', 'id' => 'patientId', 'placeholder' => 'Seleccionar Paciente', 'data-control' => 'select2', 'required']) }}
    </div>
    <div class="form-group col-sm-4 mb-5">
        {{ Form::label('doctor_name', __('messages.case.doctor').(':'),['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
        {{ Form::select('doctor_id', $doctors, null, ['class' => 'form-select form-select-solid select2Selector', 'required', 'id' => 'doctorId', 'placeholder' => 'Médico de Cabecera', 'data-control' => 'select2', 'required']) }}
    </div>
    <div class="form-group col-sm-4 mb-5">
    ...
    <!--<div class="form-group col-sm-6 mb-5">
        ...
        {{ Form::text('fee', null, ['class' => 'form-control form-control-solid price-input price']) }}
    </div>-->
