                    ...
                    <div class="card-body  border-top p-9">
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-4 d-flex flex-column text-center">
                                ...
                                <p class="m-0">
                                    <span
                                        class="badge badge-light-{{($account->type == 1) ? 'danger' : 'success'}}">{{ ($account->type == 1) ? 'Débito' : 'Crédito' }}</span>
                                </p>
                            </div>
                            <div class="col-lg-4 d-flex flex-column text-center">
                                ...
                                <p class="m-0">
                                    <span
                                        class="badge badge-light-{{($account->status == 1) ? 'success' : 'danger'}}">{{ ($account->status == 1) ? 'Activo' : 'Inactivo' }}</span>
                                </p>
                            </div>
