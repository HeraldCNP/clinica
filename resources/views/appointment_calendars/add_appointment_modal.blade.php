                ...
                <div class="row">
                    ...
                    @else
                        <div class="form-group col-sm-6 mb-5">
                            ...
                            {{ Form::select('patient_id', $patients, null, ['class' => 'form-select form-select-solid','required','id' => 'patientIdAppointment','placeholder'=>'Seleccionar Paciente']) }}
                        </div>
                    @endif
                    <div class="form-group col-sm-6 mb-5">
                        {{ Form::label('doctor_name', __('messages.case.doctor').(':'), ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
                        {{ Form::select('doctor_id', $doctorArr, null, ['class' => 'form-select form-select-solid','required','id' => 'doctorIdAppointment','placeholder'=>'Seleccionar Médico','data-control' => 'select2']) }}
                    </div>
                    <div class="form-group col-sm-6 mb-5">
