    ...
    <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="mb-5">
            <div class="mb-5">
                ...
                {{ Form::select('patient_id', $data['patients'], null, ['class' => 'form-select form-select-solid fw-bold', 'required', 'id' => 'patientId', 'placeholder' => 'Seleccionar Paciente', 'data-control' => 'select2']) }}
            </div>
        </div>
    </div>
    <div class="col-lg-4 col-md-6 col-sm-12">
    ...
    <!--<div class="col-lg-3 col-md-6 col-sm-12">
        <div class="mb-5">
            <div class="mb-5">
                ...
                <span class="text-danger">*</span>
                {{ Form::select('bed_id', [null], null, ['class' => 'form-select form-select-solid fw-bold', 'id' => 'bedId', 'disabled', 'data-control' => 'select2', 'placeholder' => 'Bed Id']) }}
            </div>
        </div>
    </div>-->
    <div class="col-lg-4 col-md-6 col-sm-12">
