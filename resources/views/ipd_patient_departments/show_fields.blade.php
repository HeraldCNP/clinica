                ...
                <div class="flex-grow-1">
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        ...
                        <div class="d-flex col-12">
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                <div class="d-flex align-items-center"><i
                                        class="fas fa-file fa-2x me-2 text-warning"></i>
                                    <div class="fs-2 fw-bolder text-gray-800" data-kt-countup="true"
                                         data-kt-countup-value="{{ !empty($ipdPatientDepartment->patient->documents) ? $ipdPatientDepartment->patient->documents->count() : ''}}">
                                        0
                                    </div>
                                </div>
                                <div
                                    class="fw-bold fs-6 text-gray-400">{{__('messages.patient.total_documents')}}</div>
                            </div>
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                <div class="d-flex align-items-center"><i
                                        class="fas fa-calendar-check fa-2x me-2 text-primary"></i>
                                    <div class="fs-2 fw-bolder text-gray-800" data-kt-countup="true"
                ...
                <div>
                    <div class="card-body  border-top p-9">
                        ...
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8">
                                <span
                                        ...
                                        title="{{ \Carbon\Carbon::parse($ipdPatientDepartment->admission_date)->diffForHumans() }}">{{ date('j M, Y h:i A', strtotime($ipdPatientDepartment->admission_date)) }}</span>
                            </div>
                        </div>
                        <div class="row mb-7">
                            <label
                        ...
                        <!--<div class="row mb-7">
                            ...
                            <div class="col-lg-8 d-flex align-items-center">
                                <span
                                    class="fw-bolder fs-6 text-gray-800 me-2">{{ $ipdPatientDepartment->title }}</span>
                            </div>
                        </div>-->
                        <!--<div class="row mb-7">
                            ...
                            <div class="col-lg-8 d-flex align-items-center">
                                <span
                                    class="fw-bolder fs-6 text-gray-800 me-2">{{ $ipdPatientDepartment->name }}</span>
                            </div>
                        </div>-->
                        <div class="row mb-7">
                            <label
