    ...
    <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="mb-5">
            <div class="mb-5">
                ...
                {{ Form::select('patient_id', $data['patients'], null, ['class' => 'form-select form-select-solid fw-bold', 'required', 'id' => 'patientId', 'placeholder' => 'Seleccionar Paciente', 'tabindex' => '1', 'data-control' => 'select2']) }}
            </div>
        </div>
    </div>
    <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="mb-5">
            <div class="mb-5">
                ...
                <span class="text-danger">*</span>
                {{ Form::select('case_id', [null], null, ['class' => 'form-select form-select-solid fw-bold', 'required', 'id' => 'caseId', 'disabled', 'data-control' => 'select2', 'placeholder' => 'Elegir Caso']) }}
            </div>
        </div>
    </div>
    <div class="col-lg-4 col-md-6 col-sm-12">
    ...
    <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="mb-5">
            <div class="mb-5">
                ...
                <span class="text-danger">*</span>
                {{ Form::select('doctor_id', $data['doctors'], null, ['class' => 'form-select form-select-solid fw-bold', 'required', 'id' => 'doctorId', 'placeholder' => 'Seleccionar Médico', 'data-control' => 'select2', 'tabindex' => '6']) }}
            </div>
        </div>
    </div>
    <div class="col-lg-4 col-md-6 col-sm-12">
    ...
    <!--<div class="col-lg-3 col-md-6 col-sm-12">
        <div class="mb-5">
            <div class="mb-5">
                ...
                <span class="text-danger">*</span>
                {{ Form::select('bed_type_id', $data['bedTypes'], null, ['class' => 'form-select form-select-solid fw-bold', 'id' => 'bedTypeId', 'placeholder' => 'Select Bed Type', 'data-control' => 'select2', 'tabindex' => '7']) }}
            </div>
        </div>
    </div>-->
    <!--<div class="col-lg-3 col-md-6 col-sm-12">
        <div class="mb-5">
            <div class="mb-5">
                ...
                <span class="text-danger">*</span>
                {{ Form::select('bed_id', [null], null, ['class' => 'form-select form-select-solid fw-bold', 'id' => 'bedId', 'disabled', 'data-control' => 'select2', 'placeholder' => 'Choose Bed']) }}
            </div>
        </div>
    </div>-->
    <div class="col-lg-4 col-md-6 col-sm-12">
